...
$fields['subject'] = '<p class="comment-form-subject"><label for="subject">' . ( 'Subject' ) . '</label>' . 'input id="subject" name="subject" type="text" value="' . esc_attr( $commenter[ 'comment_author_subject'] ) . '"size="30" /></p>';
