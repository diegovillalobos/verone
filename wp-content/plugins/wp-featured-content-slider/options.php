...
<div class="wrap">
    ...
    <form method="post" action="options.php"><?php wp_nonce_field('update-options'); ?>
        ...
        <input type="hidden" name="page_options" value="feat_width, feat_height, effect, timeout, feat_width, feat_height, feat_bg, feat_border, text_width, text_color, img_width, img_height" />
